This package can be used to simulate Hi-C data for highly rearranged genomes, using the [gGnome](github.com/mskilab-org/gGnome) framework developed by the Imielinski lab.
